<template>
  <div id="app">
    ...
    <div class="kiri">
      <div class="logo">
        <a rel="stylesheet" href="https://google.com">
          <h2>Happy</h2>
          <span>Notes</span>
        </a>
      </div>
    ...
    <!-- kanan -->
    <div class="kanan">
      <FormNotes :propSaveNote="saveNote" :propDataForm="dataForm" :propUpdateNote="updateNote"/>
...
export default {
  ...
  data: function () {
        return {
            dataForm: {},
            notes : [
                { id : 1 , title : 'Senin' , description : 'Ini isi notes' },
                { id : 2 , title : 'Selasa' , description : 'Ini isi notes' }
            ]
        }
  },
  components: {
  ...
  methods: {
    ...
    updateNote(id, title, description){
      ...
      let noteIndex = this.notes.find(note => note.id === id);
    },
  },
}
</script>
