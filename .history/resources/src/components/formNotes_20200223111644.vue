<template>
    <div class="formNotes">
        ...
        <div class="content">
            ...
            <textarea class="text texarea" placeholder="Tuliskan Rencana Kamu..." v-model="description"></textarea>
        </div>
        </form>
    </div>
</template>
    ...
    methods: {
        submitNote(e) {
            ...
            if(this.id === 0){
                ...
                this.propUpdateNote(this.title, this.description);
            }
            
        },
    },
    watch: {    //memantau setiap kali ada perubahan brdsrkn method yg dibuat
